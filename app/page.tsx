      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-black/90 backdrop-blur border-b border-red-900">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-10 text-lg font-semibold">
            ...
            <a href="#hizmetler" className="hover:text-red-500 duration-300">
              Hizmetler
            </a>

            <a href="#iletisim" className="hover:text-red-500 duration-300">
              İletişim
            </a>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 text-xl leading-relaxed mb-10">
              ...
              hızlı ve profesyonel şekilde sunuyoruz.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-black border border-red-900 rounded-3xl p-10 hover:-translate-y-2 duration-300 hover:border-red-500">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Profesyonel ekipmanlarla hızlı yağ ve filtre değişimi.
              </p>
            ...
            <div className="bg-black border border-red-900 rounded-3xl p-10 hover:-translate-y-2 duration-300 hover:border-red-500">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Balata ve fren sistemi kontrolü ile güvenli sürüş.
              </p>
            ...
            <div className="bg-black border border-red-900 rounded-3xl p-10 hover:-translate-y-2 duration-300 hover:border-red-500">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Bilgisayarlı arıza tespit cihazı ile hızlı kontrol.
              </p>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 text-xl">
              Bilgilerinizi bırakın, size hemen ulaşalım.
            </p>
